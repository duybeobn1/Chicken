...
void Base::testRegression()
{
    ...
    // Test loadImg() function
    bool result = loadImg("image//menu.png", renderer);
    if (!result)
    {
        fprintf(stderr, "Failed to load image! SDL_Error: %s\n", IMG_GetError());
        exit(1);
    }
    // assert(rect.w == 771 && rect.h == 480);
    cout << "Test 2 passed " << endl;
    // Test setRect() and getRect() functions
    setRect(100, 100);
    SDL_Rect r = getRect();
...
void Text::testRegression()
{
    ...
    TTF_Font *font = TTF_OpenFont("font//font1.ttf", 24);
    assert(font != NULL);

    setText("Hello World!");
    setColor(Text::RED);
    assert(loadImg("image//background.png", renderer));
...
void GiftSDL::loadImgGift(SDL_Renderer *scr)
{
    ...
    {
        loadImg("image//gift1.png", scr);
    }
    else if (gift->getGiftType() == NEUTRON)
    {
        loadImg("image//gift2.png", scr);
    }
    else if (gift->getGiftType() == BORON)
    {
        loadImg("image//gift3.png", scr);
    }
    else if (gift->getGiftType() == LEVEL_UP)
    {
        loadImg("image//level_up_1225.png", scr);
    }
}
...
void GiftSDL::testRegression()
{
    ...
    cout << "Test 1 passed " << endl;
    // Test setting and getting gift type
    // setGiftType(NEUTRON);
    // assert(getGiftType() == NEUTRON);
    cout << "Test 2 passed " << endl;
    // Test loading gift image
    loadImgGift(renderer);
    assert(objet != NULL);
    cout << "Test 3 passed " << endl;
    // Test getting gift rectangle
...
void ExplodeSDL::testRegression()
{
    ...
    loadImg("image//exp.png", renderer);
    assert(objet != NULL);
    cout << "Test 1 passed " << endl;
...
void BulletSDL::loadImgBullet(SDL_Renderer *scr, int bulletLevel, int bulletType)
{
    ...
    {
        std::string blaster = "image//blaster" + std::to_string(bulletLevel) + ".png";
    ...
    {
        std::string neutron = "image//neutron" + std::to_string(bulletLevel) + ".png";
    ...
    if (bulletType == BORON)
    {
        std::string boron = "image//boron" + std::to_string(bulletLevel) + ".png";
...
void ChickenSDL::initBullet(BulletSDL *pBullet, ChickenSDL *chicken, SDL_Renderer *scr)
{
    if (pBullet)
    {
        if (pBullet->loadImg("image//egg.png", scr))
        {
            Bullet *bullet = new Bullet();
...
void BossSDL::initBullet(BulletSDL *pBullet, SDL_Renderer *scr, BossSDL *boss)
{
    if (pBullet != NULL)
    {
        if (pBullet->loadImg("image//egg_boss.png", scr))
        {
            Bullet *bullet = new Bullet();
            bullet->setMove(true);
...
//     boss1->setHeart(10);
//     BossSDL bossSDL1;
//     bossSDL1.setBoss(boss1);
//     bossSDL1.decrease(2.5f);
//     assert(bossSDL1.getHeart() == 7);
//     cout << "Test 1 passed" << endl;
//     delete boss1;
//     // Test setX(), setY(), getRectFrame() functions
//     Boss *boss2 = new Boss();
//     boss2->setX(50);
//     boss2->setY(100);
//     BossSDL bossSDL2;
//     bossSDL2.setBoss(boss2);
//     SDL_Rect rectFrame = bossSDL2.getRectFrame();
//     assert(rectFrame.x == SCREEN_WIDTH && rectFrame.y == SCREEN_HEIGHT / 2);
//     cout << "Test 2 passed" << endl;
//     delete boss2;
//     // // Test setHeart() function
//     BossSDL bossSDL3;
//     bossSDL3.setBoss(boss2);
//     bossSDL3.setHeart(5);
//     assert(bossSDL3.getHeart() == 5);
//     cout << "Test 3 passed" << endl;
//     // Test getBulletList() function
//     Boss *boss3 = new Boss();
//     BossSDL bossSDL4;
//     bossSDL4.setBoss(boss3);
//     Bullet *bullet1 = new Bullet();
//     std::vector<Bullet *> bulletList1 = boss3->getBulletList();
//     bulletList1.push_back(bullet1);
//     boss3->setBulletList(bulletList1);
//     std::vector<Bullet *> bulletList = bossSDL4.getBulletList();
//     assert(bulletList.size() == 1 && bulletList[0] == bullet1);
//     cout << "Test 4 passed" << endl;
//     delete boss3;
//     delete bullet1;
//     // Test move() function
...
//     boss4->setX(1);
//     boss4->setY(2);
//     boss4->setStatusChickenLeft(true);
//     BossSDL bossSDL5;
//     bossSDL5.setBoss(boss4);
//     bossSDL5.move();
//     assert(bossSDL5.getRect().x == SCREEN_WIDTH && bossSDL5.getRect().y == SCREEN_HEIGHT / 2 + boss4->getY());
//     cout << "Test 5 passed" << endl;
//     delete boss4;
//     // Test setClip() function
//     BossSDL bossSDL6;
//     bossSDL6.setClip();
//     assert(bossSDL6.clip[0].x == 0 && bossSDL6.clip[0].y == 0 && bossSDL6.clip[9].x == 9 * WIDTH_BOSS);
//     cout << "Test 6 passed" << endl;
//     // Test makeBullet() function
//     Boss *boss5 = new Boss();
//     boss5->setX(SCREEN_WIDTH / 2);
//     boss5->setY(SCREEN_HEIGHT / 2);
//     BossSDL bossSDL7;
//     bossSDL7.setBoss(boss5);
//     Bullet *bullet2 = new Bullet();
//     std::vector<Bullet *> bulletList2 = boss5->getBulletList();
//     bulletList2.push_back(bullet2);
//     boss5->setBulletList(bulletList2);
//     SDL_Renderer *renderer = nullptr; // pass in a valid SDL_Renderer pointer here
//     bossSDL7.initBullet(bullet2, renderer, boss5);
//     bossSDL7.makeBullet(renderer, boss5);
//     assert(bullet2->getMove() == true);
...
void PlayerSDL::testRegression()
{
    ...
    playerSDL->player->setHeart(1);
    playerSDL->player->setStatus(false);
    playerSDL->control(event, renderer, bulletSound, 1, gSoundLevelUp, playerSDL->getPlayer());
    assert(playerSDL->player->getStatus() == true);
    cout << "Test 4 passed" << endl;
    ...
    playerSDL->handleBullet(renderer, playerSDL);
    assert(playerSDL->player->getBulletList().empty());
    cout << "Test 6 passed" << endl;
    delete bullet;
    delete player;
    delete playerSDL;
...
bool ControlSDL::checkCollision(const SDL_Rect &objet1, const SDL_Rect &objet2)
{
    int left_a = objet1.x;
...
bool ControlSDL::check_mouse_vs_item(const int &x, const int &y, const SDL_Rect &rect)
{
...
void ControlSDL::menu(const std::string &item)
{
    Base *menu = new Base();
    Base *menu2 = new Base();
    Base *menu3 = new Base();
    ...
    if (!menu3->loadImg("image//background.png", gRenderer))
    {
        isRunning = false;
        return;
    }
    ...
    while (quit)
    {
        ...
        else if (menu_number == 2)
        {
            ...
            text[0].setText("TOP 1 : " + std::to_string(highScore.at(highScore.size() - 1)));
            ...
            text[1].setText("TOP 2 : " + std::to_string(highScore.at(highScore.size() - 2)));
            ...
            text[2].setText("TOP 3 : " + std::to_string(highScore.at(highScore.size() - 3)));
            ...
            text[3].setText("TOP 4 : " + std::to_string(highScore.at(highScore.size() - 4)));
            ...
            text[4].setText("TOP 5 : " + std::to_string(highScore.at(highScore.size() - 5)));
...
void ControlSDL::resetGame()
{
    ...
    time_end_game = 0;
    PlayerSDL *spaceship = new PlayerSDL();
    Player *sub_player = new Player();
    spaceship->setPlayer(sub_player);
    sub_player->setBulletType(BLASTER);
    sub_player->setStatus(true);
    sub_player->setHeart(CHICKEN_HEART);
    spaceship->setPlayer(sub_player);
...
void ControlSDL::init(std::string title)
{
    if (SDL_Init(SDL_INIT_VIDEO) < 0)
    {
        isRunning = false;
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                gSoundBullet[0] = Mix_LoadWAV("sound//blaster.wav");
                gSoundBullet[1] = Mix_LoadWAV("sound//neutron.wav");
                gSoundBullet[2] = Mix_LoadWAV("sound//boron.wav");
                gSoundExp[0] = Mix_LoadWAV("sound//exp.wav");
                gSoundExp[1] = Mix_LoadWAV("sound//exp_uco.wav");
                gSoundChickenHit[0] = Mix_LoadWAV("sound//ChickenHit.wav");
                gSoundChickenHit[1] = Mix_LoadWAV("sound//ChickenHit2.wav");
                gSoundChickenHit[2] = Mix_LoadWAV("sound//ChickenHit3.wav");
                gSoundLevelUp = Mix_LoadWAV("sound//level_up.wav");
                gMusicStart = Mix_LoadMUS("sound//start.mp3");
                ...
                gFontText = TTF_OpenFont("font//font1.ttf", 24);
                gFontMenu = TTF_OpenFont("font//font1.ttf", 50);
                gFontEndGame = TTF_OpenFont("font//font1.ttf", 60);
                ...
                for (int sb = 0; sb < (int)s_bullet_list.size(); sb++)
                {
                    ...
                    if (p_bullet != NULL)
                    {
                        ...
                        if (Col3)
                        {
                            ...
                            p_chicken->decrease((spaceship->getBulletDamage()) + bullet_level * BULLET_DAMAGE_LEVEL_UP);
            ...
            for (int sb = 0; sb < (int)s_bullet_list.size(); sb++)
            {
                ...
                if (p_bullet != NULL)
                {
                    ...
                    if (Col3)
                    {
                        ...
                        sub_boss->decrease((spaceship->getBulletDamage()) + bullet_level * BULLET_DAMAGE_LEVEL_UP);
